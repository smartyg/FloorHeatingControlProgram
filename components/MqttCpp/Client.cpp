...
namespace MqttCpp {
	 ...
	 */
	bool Client::setUri(const char* uri) {
	 ...
	 */
	bool Client::publish(const char* const topic, const char* const msg, const int& msg_len, const int& qos, const bool& retain, const bool& block) {
	 ...
	 */
	bool Client::subscribe(const char* const topic, const Callback callback, const int& qos, void* user_data) {
	 ...
	 */
	void Client::eventHandler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data) {
	 ...
	 */
	bool Client::matchTopic(const char* const str1, const int& str1_len, const char* const str2, const int& str2_len) noexcept {
